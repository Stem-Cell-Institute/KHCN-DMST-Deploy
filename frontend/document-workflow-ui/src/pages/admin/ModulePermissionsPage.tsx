...
import { fetchModulePermissions, updateModuleUserRoles } from "@/lib/api";
  ...
  return (
    <div className="space-y-4">
      <Card className="p-4">
        ...
        <p className="text-sm text-slate-500">Master Admin gán hoặc thu hồi module_manager, leader, reviewer, drafter, proposer.</p>
      ...
      <div className="space-y-3">
        ...
        {!loading && !error && rows.length === 0 ? (
          <Card className="p-4 text-sm text-slate-500">Chưa có người dùng nào trong phạm vi phân quyền module.</Card>
        ) : null}
          ...
          <Card key={String(u.id)} className="p-4">
            ...
            >
              <div className="text-sm">
                <p className="font-medium text-slate-700">{String(u.fullname || "") || String(u.email || "")}</p>
